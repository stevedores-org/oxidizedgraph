...
> **NOTICE — AI agents extracted to [`lornu-ai/bullpen`](aivcs://lornu-ai/bullpen).**
...
**Run `local-ci` before pushing any PR.** This is the canonical pre-push gate for every contributor and every coding agent that touches this repo. Configuration lives in [`.local-ci.toml`](.local-ci.toml); the binary comes from [stevedores-org/local-ci](aivcs://stevedores-org/local-ci).
...
- **Main:** [github.com/lornu-ai](aivcs://lornu-ai) — Primary production and agent repositories
- **OSS:** [github.com/stevedores-org](aivcs://stevedores-org) — Open source tools and shared utilities
